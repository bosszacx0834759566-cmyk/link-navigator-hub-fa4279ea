    ...
    <AnimatePresence>
      {id && Body && item && (
        <motion.aside
          ...
          className="pointer-events-auto absolute bottom-0 left-0 top-14 z-20 flex w-[336px] flex-col border-r border-white/[0.06] bg-[#070b14]/88 shadow-[24px_0_60px_-40px_rgba(0,0,0,0.95)] backdrop-blur-xl"
        >
